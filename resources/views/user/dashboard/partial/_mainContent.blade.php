                                ...
                                <div class="card-body p-4">
                                    <div class="row align-items-center">
                                        <div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg">
                                            ...
                                            <p class="tx-white-7 mb-1">شما دو پروژه برای اتمام دارید ، <b class="text-warning">57٪</b> از سطح ماهیانه خود را تکمیل کرده اید ، به سطح خود ادامه دهید</p>
                                        </div>
                                        <img src="{{asset('backEnd\img\pngs\work3.png')}}" alt="user-img" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header border-bottom-0">
                                    <div>
                                        <label class="main-content-label mb-2">بودجه پروژه بودجه </label>
                                        <span class="d-block tx-12 mb-0 text-muted">پروژه ابزاری است که توسط مدیران پروژه برای تخمین هزینه کل یک پروژه استفاده می شود</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-header border-bottom-0 pt-0 pl-0 pr-0 d-flex">
                                        ...
                                        <div class="mr-auto">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="#">وضعیت </a><a class="dropdown-item" href="#">تیم </a> <a class="dropdown-item" href="#">وظیفه</a><a class="dropdown-item" href="#"></a>
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap mb-0 border">
                                            ...
                                            <tr>
                                                <td class="font-weight-semibold d-flex">
                                                    <label class="ckbox my-auto ml-4 mt-1"><input checked="" type="checkbox" /><span></span></label><span class="mt-1">ارزیابی طرح</span>
                                                </td>
                                                <td class="text-nowrap">
                                                    <div class="demo-avatar-group my-auto float-right">
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/1.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/2.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/3.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/4.jpg" />
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="font-weight-semibold d-flex">
                                                    <label class="ckbox my-auto ml-4"><input checked="" type="checkbox" /><span></span></label><span class="mt-1"> ایده هایی برای طراحی ایجاد کنید</span>
                                                </td>
                                                <td class="text-nowrap">
                                                    <div class="demo-avatar-group my-auto float-right">
                                                        <div class="main-img-user avatar-sm">
                                                        ...
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/6.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/7.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/8.jpg" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">37<i class=""></i></td>
                                            ...
                                            <tr>
                                                <td class="font-weight-semibold d-flex">
                                                    <label class="ckbox my-auto ml-4"><input type="checkbox" /><span></span></label><span class="mt-1">مشکل را تعریف کنید</span>
                                                </td>
                                                <td class="text-nowrap">
                                                    <div class="demo-avatar-group my-auto float-right">
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/11.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/12.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/9.jpg" />
                                                        </div>
                                                        <div class="main-img-user avatar-sm">
                                                            <img alt="آواتار" class="rounded-circle" src="assets/img/users/10.jpg" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">37<i class=""></i></td>
                                            ...
                                            <tr>
                                                <td class="font-weight-semibold d-flex">
                                                    <label class="ckbox my-auto ml-4"><input type="checkbox" /><span></span></label><span class="mt-1">با کاربران همدردی کنید</span>
                                                </td>
                                                <td class="text-nowrap">
                                                    <div class="demo-avatar-group my-auto float-right">
                                                        <div class="main-img-user avatar-sm">
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="row row-sm">
                                ...
                                <div class="col-6">
                                    <img src="assets/img/pngs/work.png" alt="تصویر" class="best-emp" />
                                </div>
                            </div>
                        </div>
                    </div>
