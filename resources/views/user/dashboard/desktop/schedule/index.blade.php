                        ...
                        <div class="card custom-card pt-2">
                            <div class="card-header border-bottom-0 pb-0">
                                <div class="d-flex justify-content-center">
                                    <h3 class="font-weight-bold">دفتر برنامه‌ریزی</h3>
                                </div>
                            </div>
                            @include('alert.alert')
                            <form class="col-12 mt-3" action="{{ route('user.dashboard.schedule.store') }}" method="post">
                             @csrf
                                <div class="col-12">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select name="lesson_id"  class="form-control" id="lessonOptions" data-url="{{ route('searchSessions') }}">
                                                ...
                                                @foreach($lessons as $lesson)
                                                    <option value="{{ $lesson->id }}" @if(old('lesson_id') == $lesson->id) selected @endif>{{ $lesson->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-6">
                                    ...
                                    <div class="row-cols-2 row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" name="startTime" id="startTime" class="form-control bs-timepicker" value="{{ old('startTime', '00:00') }}">
                                        </div>
                                    </div>
                                    <div class="row-cols-2 row">
                                        <div class="form-group col-6">
                                            <label for="endTime" class="form-label">زمان پایان:</label>
                                            <input type="text" name="endTime" id="endTime" class="form-control bs-timepicker" value="{{ old('endTime', '00:00') }}">
                                        </div>
                                        <div class="form-group col-6">
                                            <label for="type" class="form-label">نوع یادگیری را انتخاب کنید:</label>
                                            <select name="type" class="form-control" id="type">
                                                <option value="0" @if(old('type') == 0) selected @endif>مطالعه</option>
                                                <option value="1" @if(old('type') == 1) selected @endif>مطالعه و حل سوال تشریحی</option>
                                                <option value="2" @if(old('type') == 2) selected @endif>حل سوال تشریحی</option>
                                                <option value="3" @if(old('type') == 3) selected @endif>مطالعه و حل تست</option>
                                                <option value="4" @if(old('type') == 4) selected @endif>حل تست</option>
                                                <option value="5" @if(old('type') == 5) selected @endif>آزمون</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-12 row" >
                                    <div class="form-group col-12" >
                                        ...
                                        <textarea dir="rtl" name="description" class="form-control col-12 editor" id="description">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-horizontal col-12 w-100">
                                        <li class="list-group-item col-4">
                                            <a class="page-link py-10 @if($type == 'month') text-white bg-info @endif" href="{{ route('user.dashboard.schedule.index', ['type' => 'month']) }}">برنامه ماهیانه</a>
                                        </li>
                                        <li class="list-group-item col-4">
                                            <a class="page-link py-10 @if($type == 'week') text-white bg-info @endif" href="{{ route('user.dashboard.schedule.index', ['type' => 'week']) }}"> برنامه هفتگی</a>
                                        </li>
                                        <li class="list-group-item col-4">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    @foreach($lessons as $lesson)
                                                        <a href="{{ route('user.dashboard.schedule.index', ['type' => 'lesson', 'lesson' => $lesson->id]) }}" class="dropdown-item">{{ $lesson->title }}</a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </li>
