...
<head>
    ...
    <title>انتخاب عملیات ضمایم</title>
</head>
            ...
            <div class="col-xl-12 py-20">
                <div class=" row col-xl-12 text-center justify-content-center">
                    <div
                        ...
                        <a href="{{ route('overview.appendices', [$book->id, 0]) }}" class="btn ">خلاصه درس</a>
                    </div>
                    <div
                        class="col-xl-1 books-slider rounded-circle mx-4 my-2 col-md-1 col-3 slider-items d-flex justify-content-center">
                        <a href="{{ route('overview.appendices', [$book->id, 1]) }}" class="btn ">جدول</a>
                    </div>
                    <div
                        class="col-xl-1 books-slider rounded-circle mx-4 my-2 col-md-1 col-3 slider-items d-flex justify-content-center">
                        <a href="{{ route('overview.appendices', [$book->id, 2]) }}" class="btn ">پیوست‌ها</a>
                    </div>
                </div>
            </div>
        </div>
