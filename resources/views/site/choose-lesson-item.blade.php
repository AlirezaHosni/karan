...
<head>
    ...
    <title>انتخاب عملیات کتاب</title>
</head>
            ...
            <div class="col-xl-12 py-20">
                <div class=" row col-xl-12 text-center justify-content-center">
                    <div
                        ...
                        <a href="{{route('overview.book', [$lesson->id])}}" class="btn ">بیوگرافی کتاب </a>
                    </div>
                    <div
                        class="col-xl-1 books-slider rounded-circle mx-4 my-2 col-md-1 col-3 slider-items d-flex justify-content-center">
                        <a href="{{route('overview.book', [$lesson->id])}}" class="btn ">{{ $lesson->title }} در کنکور</a>
                    </div>
                    <div
                        class="col-xl-1 books-slider rounded-circle mx-4 my-2 col-md-1 col-3 slider-items d-flex justify-content-center">
                        <a href="{{route('overview.book', [$lesson->id])}}" class="btn ">{{ $lesson->title }} در امتحان پایانی</a>
                    </div>
                    <div
                        class="col-xl-1 books-slider rounded-circle mx-4 my-2 col-md-1 col-3 slider-items d-flex justify-content-center">
                        <a href="{{route('overview.book', [$lesson->id])}}" class="btn "> بررسی کتاب و نحوه مطالعه </a>
                    </div>
                </div>
            </div>
        </div>
