                ...
                <div class="row row-sm mt-5">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
                        <div class="card custom-card pt-5">
                            <form action="{{route('book-part.store')}}" method="post" class=" d-flex justify-content-center" enctype="multipart/form-data">
                                @csrf
                                <div class="d-flex flex-column col-12">
                                    ...
                                    <div class="form-group">
                                        <label for="part" class="form-label">بخش مورد نظر را بنویسید:</label>
                                        <input type="text" name="part" id="part" value="{{ old('part') }}" autocomplete="off" class="form-control " placeholder="عنوان بخش" />
                                    </div>
