                ...
                <div class="row row-sm mt-5">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
                        <div class="card custom-card pt-5">
                            @include('alert.alert')
                            <form action="{{ route('news.update', $specifiedNews->id) }}" method="post" class=" d-flex justify-content-center">
                                @csrf
                                @method('put')
                                <div class="d-flex row d-flex justify-content-center col-12">
                                    <div class="form-group col-12 row">
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" name="title" id="title" value="{{ old('title', $specifiedNews->title) }}" class="form-control" />
                                        </div>
                                        <div class="form-group col-12">
                                            <label for="editor1" class="form-label text-dark">بدنه</label>
                                            <textarea name="body" class="form-control col-12 editor" id="editor1">{{ old('body', $specifiedNews->body) }}</textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="card-header border-bottom-0 pb-0">
                                ...
                                <div class="d-flex justify-content-center">
                                    <label class="main-content-label mb-0 pt-1">لیست اخبار ثبت ‌شده</label>
                                </div>
                                <hr>
                            </div>
                            <div class="card-body">
