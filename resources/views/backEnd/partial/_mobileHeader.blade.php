            ...
            <div class="d-flex order-lg-2 mr-auto">
                ...
                <div class="dropdown main-profile-menu">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item border-top" href="profile.html"> <i class="fe fe-user"></i> پروفایل من </a>
                        <a class="dropdown-item" href="profile.html"> <i class="fe fe-edit"></i> ویرایش نمایه </a>
                        ...
                        <a class="dropdown-item" href="signin.html"> <i class="fe fe-power"></i> خروج از سیستم </a>
                    </div>
                </div>
            </div>
        </div>
