                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                ...
                                <form action="{{route('textBook.store')}}" method="post" id="fileUploadForm" class="my-5" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row ">
                                        <div class="col-12 offset-3">
                                            <div class="form-group">
                                                ...
                                                <select name="book_id"  class="form-control">
                                                    @foreach($books as $book)
                                                        <option value="{{$book->id}}" @if($book->id == old('book_id')) selected @endif>{{ $book->session }}-{{ $book->part }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea name="body" id="editor1" style="resize: none;">{{ old('body') }}</textarea>
                                            </div>
