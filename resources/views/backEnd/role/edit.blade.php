                        ...
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div class="d-flex justify-content-between">
                                    <label class="main-content-label mb-0 pt-1">اصلاح نقش</label>
                                    <div class="mr-auto float-right">
                                        <a href="{{route('role.index')}}" class="btn btn-info"> <i class="fa fa-arrow-right mx-2"></i>برگشت به لیست</a>
                                    </div>
                                </div>
                                <p class="tx-12 tx-gray-500 mt-0 mb-2">مدیریت / نقش ها / اصلاح نقش </p>
                                <!-- create Session  -->
                                @if(session('success'))
                                    ...
                                    <div class="d-flex row ">
                                        <div class="col-xl-6 col-md-6 offset-3">
                                            <div class="form-group">
                                                <input type="text" name="name" class="form-control" value="{{$role->name}}" placeholder="نقش " />
                                            </div>
                                            <div class="form-group">
