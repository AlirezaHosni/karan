                ...
                <div class="row row-sm mt-5">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
                        <div class="card custom-card pt-5">
                            ...
                            <form action="{{ route('education.descriptiveTestAttachmentsStore') }}" method="post" class=" d-flex justify-content-center" id="form" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                        ...
                                        @foreach($videos as $video)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-center">
                                                    <a href="{{ route('education.descriptiveTestAttachments.edit', $video->videoable->id) }}" class="btn btn-success btn-sm ml-2">
                                                        <i class="fe fe-edit-2"></i>
                                                    </a>
                                                    <form action="{{ route('education.descriptiveTestAttachments.destroy', $video->videoable->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                        ...
                                        @foreach($documents as $document)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-center">
                                                    <a href="{{ route('education.descriptiveTestAttachments.edit', $document->documentable->id) }}" class="btn btn-success btn-sm ml-2">
                                                        <i class="fe fe-edit-2"></i>
                                                    </a>
                                                    <form action="{{ route('education.descriptiveTestAttachments.destroy', $document->documentable->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="btn btn-danger btn-sm" type="submit">
                                                            <i class="fe fe-trash"></i>
