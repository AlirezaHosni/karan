                                ...
                                <div class="card-body pt-0">
                                    <ul class="list-group list-group-horizontal col-12 w-100">
                                        <li class="list-group-item col-6">
                                            <a class="page-link py-10 text-white bg-info" href="{{ route('education.selectionExam.topic.test.Index') }}">موضوعی</a>
                                        </li>
                                        <li class="list-group-item col-6">
                                            <a class="page-link py-10 " href="{{ route('education.selectionExam.standard.test.Index') }}">استاندارد</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <form action="{{ route('education.selectionExam.topic.test.Store') }}" method="post" class=" d-flex justify-content-center" enctype="multipart/form-data">
                                @csrf
                                <div class="col-12">
                                    <div class="row-cols-2 row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <ul class="list-group list-group-horizontal col-12">
                                                <li class="list-group-item col-6">
                                                    <a class="page-link py-10 text-white bg-info" href="{{ route('education.selectionExam.topic.test.Index') }}">تستی</a>
                                                </li>
                                                <li class="list-group-item col-6">
                                                    <a class="page-link py-10 " href="{{ route('education.selectionExam.topic.descriptiveTest.Index') }}">تشریحی</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="form-group col-6">
...
@section('js')
    ...
    <script>
        ...
        $('#form').submit(function (){
            var topicSelected = $('#session_id').val()
            var topicInput = $('#selected_session_id')
