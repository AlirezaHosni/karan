                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                ...
                                <form action="{{route('grade.description.update', $gradeDescriptions->id)}}" method="post" class="my-5" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="row ">
                                        <div class="col-12 offset-3">
                                            <div class="form-group ">
                                                ...
                                                <textarea name="description" id="editor1" style="resize: none;">{{ old('description', $gradeDescriptions->description) }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <textarea name="descriptionTwo" id="editor2" style="resize: none;">{{ old('description', $gradeDescriptions->descriptionTwo) }}</textarea>
                                            </div>
                                            <div class="row justify-content-center  mb-5">
                                                <div class="col-10 mt-5">
                                                    <p>عکس دوم توضیحات</p>
